    ...
    <AnimatePresence>
      {topUpOpen && (
        <>
          ...
          />
          <motion.div
            className="sheet lg-surface lg-surface--strong lg-refract"
          ...
          >
            <div className="row">
              ...
              <button className="lg-button lg-button--ghost" onClick={closeTopUp} aria-label="Закрыть">
                <IconClose size={18} />
              </button>
            </div>
            ...
            <div className="form__field">
              ...
              <input
                id="custom-amount"
                className={`lg-input ${showHint ? "lg-input--error" : ""}`}
                inputMode="numeric"
                placeholder="от 50 ₽"
                value={custom}
                onChange={(e) => {
            ...
            <div className="row" style={{ justifyContent: "flex-end" }}>
              <button className="lg-button" onClick={closeTopUp}>
                Отмена
              </button>
              <motion.button
