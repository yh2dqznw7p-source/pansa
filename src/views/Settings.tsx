  ...
  return (
    ...
    >
      <div className="settings__content">
        ...
        <div className="lg-surface lg-refract card">
          ...
          <div className="row-between">
            ...
            <span className={`role-badge role-${s.user?.role ?? "user"}`}>
              {s.user?.role ?? "user"}
            </span>
          </div>
        </div>
        ...
        <div className="lg-surface lg-refract card">
          ...
          <div className="row-between">
            <div>
              ...
              <div className="subtle" style={{ fontSize: 12, marginTop: 2 }}>
                Собеседник видит, что вы прочли сообщение
              </div>
            </div>
            <Toggle checked={s.readReceipts} onToggle={() => s.toggle("readReceipts")} />
          </div>
          <div className="row-between">
            <div>Показывать время последнего визита</div>
        ...
        <div className="lg-surface lg-refract card">
          ...
          <div className="row-between">
            <div>
              ...
              <div className="subtle" style={{ fontSize: 12, marginTop: 2 }}>
                Меньше отступов, больше сообщений на экране
              </div>
            </div>
          ...
          <div className="row-between">
            <div>Поддержка</div>
            <button className="lg-button" onClick={() => api.openSupport()}>
              Открыть консоль поддержки
            </button>
          </div>
        </div>
      </div>
      ...
      <div className="settings__footer">
        <motion.button
          className="lg-button lg-button--danger settings__logout"
          whileTap={{ scale: 0.99 }}
          onClick={s.logout}
        >
          Выйти из аккаунта
